...
# 由于作者本人的原因，系统暂时(多半是永久)摆烂，因为现有功能(不包括有bug的)已经可以完成本人日常简单功能，当然我也会去找个源码网下载一个更牛逼的自己用。至少站群可以用吧(自嘲罢了)，当然，本系统是基于Apache 2.0开源的，只需在部分代码注释中保留auther即可随意二开商用。当然，我本人也不是这个圈子里面的人(准确来说只是解除了皮毛罢了，尽管这是灰产，但是这是任何一个正常网站&非盈利网站也需要的，这就是本系统的初衷，写多租户计费也是为了打破SaaS系统的规则:能打的系统一定要钱，当然我失败了，不然你也不会看到这些)，所以大家更应该看看其他大佬的作品，而不是看我这个失败者的。别了各位，我还有学业&其他奇思妙想需要完成，希望有缘再见！最后说明:本系统100%没用商业版等版本，如果看见了，这纯属巧合/二开系统等(本人发誓)，作者的初衷也只有两个词：开源&不求回报(也没收过钱，项目也就2star)！我一学生党，系统60%代码都是靠AI，属实让各位见笑(不过能看到本信息的应该也不超过10人)。总结一下：我是一个学生，用AI写了60%的代码，想做一个批量建站，本身我就是做个玩具，只是想法越来越多，就开始乱搞。站群真的能用，AI模块是有问题的，安全组件是啥都报拦截的，GitHub上只有2个Star。我不玩了，要开学了真的要写作业了，反正也没人看，当我是🤡得了。

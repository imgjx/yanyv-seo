...
layui.use(['form', 'layer'],function(){
    ...
    form.on('submit(install)',function(data){
        ...
        var d = data.field;
        var url = '?s=4&dbhost='+d.dbhost+'&dbname='+d.dbname+'&dbpre='+d.dbpre+'&dbuser='+d.dbuser+'&dbpwd='+encodeURIComponent(d.dbpwd)+'&dbport='+d.dbport+'&overwrite='+d.overwrite+'&adminuser='+d.adminuser+'&adminpass='+d.adminpass;
        layer.open({
            type: 1,
            area: ['500px', '300px'],
            title: '安装处理中，请勿关闭...',
            ...
            success: function(){
                ...
                xhr.onreadystatechange = function () {
                    if (xhr.readyState === 4 && xhr.status === 200) {
                        layer.msg('安装成功',{icon:1,shade:0.2,time:3000},function(){top.location.href = '?s=5';});

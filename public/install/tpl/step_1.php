<?php defined('ROOT_DIR') or exit('Nothing');?><div class="main">
    ...
    <div class="text">
        <h3>尊敬的用户：</h3>
        <p>感谢您选择使用YanyvSEO（以下简称“本系统”）本系统官网为： <a href="https://www.veitool.com" target="_blank">https://www.veitool.com</a>，设有问答社区和相关使用文档。
        ...
        <h3>三. 有限担保和免责声明</h3>
        <p>本系统及所附带的文件是作为不提供任何明确的或隐含的赔偿或担保的形式提供的。用户出于自愿而使用本系统，您必须了解使用本系统的风险，在尚未购买产品技术服务之前，我们不承诺提供任何形式的技术支持、使用担保，也不承担任何因使用本系统而产生问题的相关责任。YanyvSEO不对使用本系统构建的网站和应用中的内容或信息承担责任。</p>

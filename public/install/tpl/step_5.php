<?php defined('ROOT_DIR') or exit('Nothing');?><div class="main" >
	...
	<div class="note">
		<div class="isok">
            <p><a href="../" class="layui-btn">访问首页</a> <a href="../system/" class="layui-btn layui-btn-normal">登录后台</a> <a href="https://seo.yanyv.cc/" target="_blank" class="layui-btn layui-btn-warm">YanyvSEO官网</a></p>
